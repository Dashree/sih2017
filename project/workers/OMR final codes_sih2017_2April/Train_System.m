function [master_width, master_height, roll_no_segment, Centre_Code_segment, Answer_segment, Image_segment, Image_seg, roll_No, Centre_ID, Ans_Seg]=Train_System(BW)
